Gem::Specification.new do |s|
   ...
   s.description = %q{GCal4Ruby is a Ruby Gem that can be used to interact with the current version of the Google Calendar API. GCal4Ruby provides the following features:\n\n* Create and edit calendar events\n* Add and invite users to events\n* Set reminders\n* Make recurring events}
